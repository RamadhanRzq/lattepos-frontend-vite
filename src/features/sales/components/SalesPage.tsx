...
export function SalesPage() {
  ...
  function voidOrder() {
    if (cart.length === 0) return
    if (!confirm('Void pesanan ini? Semua item akan dihapus.')) return
    setCart([])
  }
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex rounded-lg border border-border bg-surface">
              ...
              >
                <SquaresFourIcon size={16} weight={view === 'grid' ? 'fill' : 'regular'} />
              </button>
              <button
                type="button"
              ...
              >
                <ListIcon size={16} weight={view === 'list' ? 'bold' : 'regular'} />
              </button>
            </div>
          </div>
        </div>
